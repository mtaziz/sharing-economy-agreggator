 ...
 */
class App_View_Helper_Link extends Zend_View_Helper_Url
{
    /**
     * Crée un lien de manière plus intuitive que l'aide "Url"
     * 
     ...
     * @return string
     */
    public function link($controllerName = null, $actionName = null, $params = '', $moduleName = null, $name = 'default', $reset = true)
    {
